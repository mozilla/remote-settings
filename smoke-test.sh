...
curl --fail -X POST -H "Content-Type: multipart/form-data" -H "Authorization: Basic dXNlcjpwYXNz" -F "attachment=@/etc/hostname" "http://localhost:8888/v1/buckets/default/collections/articles/records/abcde/attachment"
# kinto-signer test
