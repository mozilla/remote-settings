...
This document used to describe changes in each release.

> 32.0.0
========

Since version 32, we use `Github releases <https://github.com/mozilla/remote-settings/releases>`_ and autogenerated changelogs.
